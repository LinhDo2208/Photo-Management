...
int isSame(Linkedlist H, char newPath[])
{
    ...
    while (p != NULL)
    {
        if (compareFile(p->data.path, newPath) == 1)
            return 1; // Trùng
        p = p->next;
    }
...
int main()
{
    ...
    while (choice != 0)
    {
        ...
        printf("3.");
        setColor(15);
        printf(" 🔍 Find the photo by name\n");
        setColor(14);
        printf("4.");
        setColor(15);
        printf(" ✏️ Edit the photo\n");
        setColor(14);
        printf("5.");
        setColor(15);
        printf(" ❌ Delete the photo\n");
        setColor(14);
        printf("6.");
        setColor(15);
        printf(" 🗑️  Recycle bin\n");
        setColor(14);
        printf("7.");
        setColor(15);
        printf(" 🔃 Sort\n");
